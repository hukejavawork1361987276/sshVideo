	...
	<menu>
		<div class="container clearfix">
			...
			<div id="user_bar">
				...
				<a href="${pageContext.request.contextPath}/front/user/exit" id="lay_out">退出</a>
			</div>
		</div>
	</menu>
</header>
